...
build/libluminin.a: lib/luminin/bd.c lib/luminin/bd.h lib/luminin/chercheur.c lib/luminin/chercheur.h lib/luminin/employe.c lib/luminin/employe.h lib/luminin/entreprise.c lib/luminin/entreprise.h lib/luminin/fwd.h lib/luminin/poste.c lib/luminin/poste.h lib/luminin/recherche.c lib/luminin/recherche.h | build
	...
	gcc -Wall -Werror -pedantic -g -I lib -c lib/luminin/recherche.c -o build/luminin/recherche.o
	ar crs build/libluminin.a build/luminin/bd.o build/luminin/chercheur.o build/luminin/employe.o build/luminin/entreprise.o build/luminin/poste.o build/luminin/recherche.o
